 ...
 * Winter 2018 Purpose: This class drives the menu for Assignment 2 - Inventory
 * system
 *
 ***********************************************************************************************/
public class Assign2Main {
	...
	public static void main(String[] args) {
		...
		while (option != 7) {
			System.out.printf(
					"%n1 to add an item to inventory,%n2 to display current inventory,%n3 buy some of an item,%n4 sell some of an item, %n5 to create a file,%n6 to read a file,%n7 to quit %n");
